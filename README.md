...
## Notes:
+ If playing on mobile, due to limitations of this version, you can simply send out all of the lost ball or fox hunt checks once you gain access to the course as this version does not let you create additional profiles to "recollect" the lost balls, nor does it have fox hunts as of writing due to limitations with the mobile versions movement.
